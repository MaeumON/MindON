      ...
      <div className="maincontent p-[10px]">
        ...
        <div className="flex flex-col gap-[20px] p-[20px] mt-[20px]">
          ...
          <div className="flex flex-col gap-5">
            {/* nav 주소 수정 예정 */}
            <Card onClick={() => nav("/mydata/grouplist/1?page=1&size=10&sort=startDate,asc")} className="items-center">
            ...
            <Card onClick={() => nav("/mydata/grouplist/2?page=1&size=10&sort=startDate,asc")} className="items-center">
              <div className="ps-[10px] py-[5px]">
                <div className="flex justify-between">
