    ...
    <div className="flex justify-center items-center w-full px-4">
      <div className="font-suite h-auto p-5 bg-white rounded-xl shadow-md flex flex-col justify-center items-start gap-3 w-full max-w-[600px]">
        ...
        <div className="flex flex-col justify-start items-start w-full gap-2">
          <div className="text-cardTitle text-lg md:text-xl font-bold truncate w-full">{group.title}</div>
          <div className="flex flex-wrap justify-start items-center gap-x-2 gap-y-1 w-full">
            ...
            <div className="text-cardTitle text-sm md:text-base font-semibold">{group.startDate.toString()}</div>
            ...
            <div className="text-cardTitle text-sm md:text-base font-semibold">{group.meetingTime}</div>
          </div>
